...
public class PhoneUnionServiceImpl implements IPhoneUnionService {
    ...
    public String phoneH5Unionpay(HttpServletRequest request, HttpServletResponse resp, OrderData orderData) {
        ...
        // 商户号码，请改成自己的商户号
        requestUnionMap.put("merId", PropertiesUtil.getHpayValue(brand+".union.merId"));
        // 订单发送时间，取系统时间
        ...
        //多密钥签名，存日志
        Map<String, String> submitFromData = com.hand.hap.cloud.hpay.services.pcServices.union.sdk.AcpService.sign(requestUnionMap, PropertiesUtil.getHpayValue(brand+".union.certPath"), PropertiesUtil.getHpayValue(brand+".union.certPwd"), com.hand.hap.cloud.hpay.services.pcServices.union.sdk.http.UnionPayHttp.encoding);
        // 交易请求url 从配置文件读取
