...
public class UnionPayServiceImpl implements IUnionPayService {
    ...
    public String pcUnion(OrderData orderData) {
        ...
        // 商户号码，请改成自己的商户号
        requestUnionMap.put(PARAM_MERID, PropertiesUtil.getHpayValue(brand+".union.merId"));
        // 订单发送时间，取系统时间
        ...
        Map<String, String> submitData = AcpService.sign(
                requestUnionMap,
                PropertiesUtil.getHpayValue(brand+".union.certPath"),
                PropertiesUtil.getHpayValue(brand+".union.certPwd"),
